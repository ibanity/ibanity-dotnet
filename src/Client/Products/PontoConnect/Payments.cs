...
namespace Ibanity.Apis.Client.Products.PontoConnect
{
    ...
    /// </summary>
    public class Payments : ResourceWithParentClient<PaymentResponse, object, object, PaymentLinks, Token>, IPayments
    {
        ...
        public Payments(IApiClient apiClient, IAccessTokenProvider<Token> accessTokenProvider, string urlPrefix) :
