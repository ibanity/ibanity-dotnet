...
{
    /// <summary>
    /// A webhook payload delivered whenever a periodic payment initiation request status is updated.
    /// </summary>
    public class PeriodicPaymentInitiationRequestStatusUpdated : JsonApi.Data, IWebhookEvent
    {
        /// <summary>
    ...
    /// </summary>
    public class NestedPeriodicPaymentInitiationRequestStatusUpdated : PayloadData<PeriodicPaymentInitiationRequestStatusUpdatedAttributes, PeriodicPaymentInitiationRequestStatusUpdatedRelationships>
    {
        /// <inheritdoc />
        public override IWebhookEvent Flatten() =>
            new PeriodicPaymentInitiationRequestStatusUpdated
            {
                Id = Id,
                Type = Type,
    ...
    /// </summary>
    public class PeriodicPaymentInitiationRequestStatusUpdatedAttributes
    {
        /// <summary>
        /// When this notification was created.
        /// </summary>
