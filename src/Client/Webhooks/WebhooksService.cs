...
namespace Ibanity.Apis.Client.Webhooks
{
    ...
    public class WebhooksService : IWebhooksService
    {
        private static readonly IReadOnlyDictionary<string, Type> Types = new Dictionary<string, Type>
        {
            ...
            { "xs2a.bulkPaymentInitiationRequest.statusUpdate", typeof(Payload<Models.XS2A.NestedBulkPaymentInitiationRequestStatusUpdate>) },
            ...
            { "xs2a.paymentInitiationRequest.statusUpdate", typeof(Payload<Models.XS2A.NestedPaymentInitiationRequestStatusUpdate>) },
            ...
            { "xs2a.periodicPaymentInitiationRequest.statusUpdate", typeof(Payload<Models.XS2A.NestedPeriodicPaymentInitiationRequestStatusUpdate>) }
        };
